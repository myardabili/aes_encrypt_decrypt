...
import 'package:encrypt_decrypt_app/pages/file_decryption_api.dart';
...
class _DecryptPageState extends State<DecryptPage> {
  ...
  void initState() {
    super.initState();
    futureFiles = FirebaseStorage.instance.ref('/files/decrypt').listAll();
  }
                      ...
                      children: [
                        ...
                        ElevatedButton(
                          onPressed: () async {
                            ...
                            final result =
                                await FileDecryptionApi.decryptedFile(
                                    doc!.readAsBytesSync());

                            final decryptedFileName =
                                '${fileName.substring(0, fileName.lastIndexOf('.'))}.pdf';

                            await uploadDecryptedFile(
                                result!, decryptedFileName);
                          },
                          child: isEncrypting
  ...
  Future<void> uploadDecryptedFile(
      Uint8List encryptedData, String fileName) async {
    final destination = "files/decrypt/$fileName";
    try {
